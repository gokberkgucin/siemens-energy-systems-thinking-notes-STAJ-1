...
![Hidrojen verimlilik zinciri](../assets/figures/hidrojen-verimlilik-zinciri.jpg)
...
![Üretimden kullanıma enerji kayıpları](../assets/figures/enerji-kayiplari-karsilastirma.jpg)
...
![Günlük talep ve yenilenebilir üretim dalgalanması](../assets/figures/hidrojen-gunluk-talep-depolama.png)
...
Bataryalar burada güçlü bir çözüm olabilir. Ama staj defterinde de not ettiğim gibi, uzun süreli depolama için bataryaların maliyet ve ölçek açısından her yerde yeterli olmayabileceği söyleniyordu. O zaman "hidrojen nerede işe yarar?" sorusu daha dar ve daha ciddi bir hale geliyor:
...
## NREL Görselleri Neden Merkezde Değil?
...
Ama bu yazıda NREL görsellerini merkeze almadım. Çünkü o zaman yazı hidrojenin sistem sınırı ve depolama tartışmasından çıkıp, teknoloji haberleri ve grafik derlemesine dönüşebilirdi. NREL kısmının işlevi burada daha sınırlı: teknolojilerin zamanla değişebileceğini hatırlatmak.
